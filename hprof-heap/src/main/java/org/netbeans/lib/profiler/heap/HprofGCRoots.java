    ...
    Collection<GCRoot> getGCRoots() {
        synchronized (gcRootLock) {
            if (gcRoots == null) {
                ...
                List<GCRoot> rootList = new ArrayList<GCRoot>(gcRoots.values());
                Collections.sort(rootList, new Comparator<GCRoot>() {
                    public int compare(GCRoot o1, GCRoot o2) {
                        ...
                        return longCompare(r1.getInstanceId(), r2.getInstanceId());
                    }
                });
